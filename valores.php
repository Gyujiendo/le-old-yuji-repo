...
<!-- Card -->
<div class="card card-image border-rounded text-center" style="margin:auto; background-image: url(img/valores.jpg);">

  <!-- Content -->
  <div class="text-white text-center d-flex align-items-center rgba-black-light py-5 px-4">
    <div>
      <h2 style="color:#37BFD8;"><b><i class="far fa-star"></i> Valores</b></h2>
      <br>
      <span class="text-left">
      <p><span style="color:#37BFD8; font-size: 35px;">B</span><span style="font-size: 18px;">om atendimento (o que é da nossa competência é realizado com competência)</span>
      <br><br>
      <span style="color:#37BFD8; font-size: 35px;">É</span><span style="font-size: 18px;">tica (equilíbrio nas nossas ações profissionais e sociais)</span>
      <br><br>
      <span style="color:#37BFD8; font-size: 35px;">L</span><span style="font-size: 18px;">iderança (o espírito de liderança que reside em cada um é contemplado por todos)</span>
      <br><br>
      <span style="color:#37BFD8; font-size: 35px;">L</span><span style="font-size: 18px;">ealdade (dedicação e compromisso são nosso cotidiano)</span>
      <br><br>
      <span style="color:#37BFD8; font-size: 35px;">E</span><span style="font-size: 18px;">nvolvimento ( o espírito de equipe impulsiona nossas ações)</span>
      <br><br>
      <span style="color:#37BFD8; font-size: 35px;">V</span><span style="font-size: 18px;">oluntariedade (pró atividade e altruísmo são características individuais e do time bellevue)</span>
      <br><br>
      <span style="color:#37BFD8; font-size: 35px;">U</span><span style="font-size: 18px;">nião (profissionais e pacientes unidos na busca do melhor resultado)</span>
      <br><br>
      <span style="color:#37BFD8; font-size: 35px;">E</span><span style="font-size: 18px;">mpatia (amor ao próximo nos faz ser expansivos em todas as nossas boas intenções, favorecendo as relações e resultados)</span>
</p>
    </div>
  </div>

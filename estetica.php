...
<!--Navbar web-->
<nav class="mb-1 navbar navbar-expand-lg navbar-dark w-1005 position-fixed sbgbrancomobile" style="box-shadow: none; z-index:10; height:auto;">
...
<h2 style="color: #757575;"><b>Estética</b></h2>

<p style="color: #757575; font-size:14px;">A estética dental engloba desde restaurações realizadas em consultório com resinas compostas sob aplicação de luz direta, dentes provisórios, até trabalhos protéticos como coroas unitárias, lentes de contato, dentre outros procedimentos que exigem uma etapa laboratorial.<br><br> 
 O trabalho restaurador, seja ele direto ou indireto, sempre busca o perfeito restabelecimento da forma e da função. O nosso consultório odontológico em Guarulhos, possui uma equipe de profissionais que têm excelentes resultados em estética dental.<br><br>
...
<img src="img/estet1.jpg" style="height:500px; width: 45%;"/>
<img src="img/Estetica.jpeg" style="height:500px; width: 45%;"/>
<br><br>
<img src="img/estet3.jpg" style="height:500px; width: 45%;"/>
<img src="img/estet4.jpeg" style="height:500px; width: 45%;"/>
<br><br><br>
...
<span class="d-block d-sm-none text-center" style="color: black; opacity:0.7;"><h1><b>Estética</b></h1></span>
<br>
<span class="d-block d-sm-none"><img style="width: 100%; height: auto;" src="img/Estetica.jpeg"/></span>
<br><br>
<!-- Collapse buttons -->
<div class="row justify-content-around">
...
<div class="collapse" id="leiasobre" style="margin-left:10px; margin-right:10px">
  <div class="mt-3">
    ...
    <hr>
    A estética dental engloba desde restaurações realizadas em consultório com resinas compostas sob aplicação de luz direta, dentes provisórios, até trabalhos protéticos como coroas unitárias, lentes de contato, dentre outros procedimentos que exigem uma etapa laboratorial.<br><br> 
 O trabalho restaurador, seja ele direto ou indireto, sempre busca o perfeito restabelecimento da forma e da função. O nosso consultório odontológico em Guarulhos, possui uma equipe de profissionais que têm excelentes resultados em estética dental.<br><br>
...
<div class="collapse" id="galeria" style="margin-left:10px; margin-right:10px">
  <div class="mt-3">
    <p style="color: #757575; font-size:14px;">
    <hr>
    <img src="img/estet1.jpg" style="height:auto; width:100%;"/>
    <span class="d-block d-sm-none"><br></span>
    <img src="img/Estetica.jpeg" style="height:auto; width:100%;"/>
    <span class="d-block d-sm-none"><br></span>
    <img src="img/estet3.jpg" style="height:auto; width:100%;"/>
    <span class="d-block d-sm-none"><br></span>
    <img src="img/estet4.jpeg" style="height:auto; width:100%;"/>
    </p>
  </div>
</div>
<!-- / .Collapsible element 2-->

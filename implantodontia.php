...
<head>
  ...
  <title>Bellevue | Implantodontia</title>
  <!-- Font Awesome -->
...
<h2 style="color: #757575;"><b>Implantodontia</b></h2>

<p style="color: #757575; font-size:14px;">Os implantes dentários, quando bem avaliados e indicados, constituem a maneira mais estável de devolver um dente perdido por cárie, trauma, doença periodontal, entre outras. São o que há de mais moderno quando falamos de reabilitação oral e tem ganho cada vez mais espaço com a população que necessita de reposição de dentes perdidos.<br><br>

Essa popularidade impulsiona o aparecimento e melhoria das técnicas o que minimiza expressivamente intercorrências relacionadas ao tratamento quando da aplicação coerente de cada etapa do planejamento e execução.<br><br>

Nossa clínica de implantes em Guarulhos acompanhou esse desenvolvimento, nossos profissionais são altamente capacitados e possuem excelentes resultados.<br><br>
...
<img src="img/Implantodontia.jpeg" style="height: 70%; width: 70%;"/>
<br><br><br>
...
<span class="d-block d-sm-none text-center" style="color: black; opacity:0.7;"><h1><b>Implantodontia</b></h1></span>
<br>
<span class="d-block d-sm-none"><img style="width: 100%; height: auto;" src="img/Implantodontia.jpeg"/></span>
<br><br>
<!-- Collapse buttons -->
<div class="row justify-content-around">
...
<div class="collapse" id="leiasobre" style="margin-left:10px; margin-right:10px">
  <div class="mt-3">
    ...
    <hr>
    Os implantes dentários, quando bem avaliados e indicados, constituem a maneira mais estável de devolver um dente perdido por cárie, trauma, doença periodontal, entre outras. São o que há de mais moderno quando falamos de reabilitação oral e tem ganho cada vez mais espaço com a população que necessita de reposição de dentes perdidos.<br><br>
